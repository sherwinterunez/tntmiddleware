									...
									if($parse<>""){
										...
										$result=InsOSRaw($val); 
												 ...
												 /*osparse*/ 
													...
													//$receive[2][1]= substr($parse,1606,30); /* revised by Sherwin Terunez July 1, 2015 */
													$receive[2][1]= substr($parse,1605,30); /* revised by Sherwin Terunez July 1, 2015 */
...
/*
if ( item_value >= informal_value ) {
    if ( item_value >= formal_value ) {
        flag = 'FORMAL';
    } else {
        flag = 'INFORMAL';
    }
} else {
    if ( item_weight >= informal_weight ) {
        flag = 'INFORMAL';
    } else {
        if( item_weight >= informal_weight ) {
            flag = 'INFORMAL';
