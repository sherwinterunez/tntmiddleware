...
$myToolbar = array($moduleid.'balance',$moduleid.'products',$moduleid.'delete',$moduleid.'refresh');
...
///////////////////////////////////
		...
		myTab.toolbar.getToolbarData('<?php echo $moduleid; ?>balance').onClick = function(id,formval) {
		...
		myTab.toolbar.getToolbarData('<?php echo $moduleid; ?>products').onClick = function(id,formval) {
			//showMessage("toolbar: "+id,5000);
