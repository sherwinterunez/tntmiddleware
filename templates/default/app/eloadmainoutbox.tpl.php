...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setInitWidths("50, 50,100,100,50,50,*,80,120,120");

			myGrid.setColAlign("center, center,left,left,center,center,left,center,left,left");
			...
			try {
				...
				if(ddata.rows[0].id) {
					...
					//myGrid.attachHeader("&nbsp;,&nbsp;,#combo_filter,#combo_filter,#text_filter,#combo_filter,&nbsp;");
