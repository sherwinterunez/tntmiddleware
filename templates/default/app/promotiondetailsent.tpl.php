...
<script>
	...
	function <?php echo $templatedetailid.$submod; ?>_%formval%() {
		...
		//var myToolbar = ['promotionresend','promotiondelete','promotionrefresh'];

		var myToolbar = ['promotiondelete','promotionrefresh'];
...
///////////////////////////////////
		...
		myTab.toolbar.disableItem('promotionresend');
...
///////////////////////////////////
		...
		myTab.toolbar.getToolbarData('promotiondelete').onClick = function(id,formval) {
			...
			if(rowid) {
				showConfirmWarning('Deleting the message will<br />invalidate the promo code. Proceed?',function(val){
