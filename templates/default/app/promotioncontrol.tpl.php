...
////////
		...
		if($("#formdiv_%formval% #promotionmainpromosgrid").length) {

			$("#formdiv_%formval% #promotionmainpromosgrid").height(lbHeight-90);
			$("#formdiv_%formval% #promotionmainpromosgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #promotiondetailpromos").length) {

			$("#formdiv_%formval% #promotiondetailpromos").height(lcHeight-2);
			$("#formdiv_%formval% #promotiondetailpromos").width(lcWidth-2);

			$("#formdiv_%formval% #promotiondetailpromosdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #promotiondetailpromosdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #promotionmainsendgrid").length) {

			$("#formdiv_%formval% #promotionmainsendgrid").height(lbHeight-90);
			$("#formdiv_%formval% #promotionmainsendgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #promotiondetailsend").length) {

			$("#formdiv_%formval% #promotiondetailsend").height(lcHeight-2);
			$("#formdiv_%formval% #promotiondetailsend").width(lcWidth-2);

			$("#formdiv_%formval% #promotiondetailsenddetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #promotiondetailsenddetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #promotionmainclaimedgrid").length) {

			$("#formdiv_%formval% #promotionmainclaimedgrid").height(lbHeight-90);
			$("#formdiv_%formval% #promotionmainclaimedgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #promotiondetailclaimed").length) {

			$("#formdiv_%formval% #promotiondetailclaimed").height(lcHeight-2);
			$("#formdiv_%formval% #promotiondetailclaimed").width(lcWidth-2);

			$("#formdiv_%formval% #promotiondetailclaimeddetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #promotiondetailclaimeddetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #promotionmainsentgrid").length) {

			$("#formdiv_%formval% #promotionmainsentgrid").height(lbHeight-90);
			$("#formdiv_%formval% #promotionmainsentgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #promotiondetailsent").length) {

			$("#formdiv_%formval% #promotiondetailsent").height(lcHeight-2);
			$("#formdiv_%formval% #promotiondetailsent").width(lcWidth-2);

			$("#formdiv_%formval% #promotiondetailsentdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #promotiondetailsentdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #loadmainfundtochildgrid").length) {

			$("#formdiv_%formval% #loadmainfundtochildgrid").height(lbHeight-90);
			$("#formdiv_%formval% #loadmainfundtochildgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #loaddetailfundtochild").length) {

			$("#formdiv_%formval% #loaddetailfundtochild").height(lcHeight-2);
			$("#formdiv_%formval% #loaddetailfundtochild").width(lcWidth-2);

			$("#formdiv_%formval% #loaddetailfundtochilddetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #loaddetailfundtochilddetailsform_%formval%").width(lcWidth-22);
		}
...
////////
	...
	function explorer_sidebar_%formval%(){
		...
		mySideBar = mySideBar_%formval% = myTab.layout.cells('a').attachSidebar({
			...
			items: [
					{id: "promos", text: "Promos", icon: "recent.png"},
					{id: "send", text: "Send", icon: "desktop.png"},
					{id: "sent", text: "Sent", icon: "music.png"},
					{id: "claimed", text: "Claimed", icon: "downloads.png"},
	...
	function doSelect_%formval%(id, lastId){
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			odata: {},
			pdata: "routerid="+settings.router_id+"&action=formonly&formid=promotionmain"+id+"&module=promotion&formval=%formval%",
		}, function(ddata,odata){
			if(ddata.html) {
				jQuery("#formdiv_%formval% #promotionmain").parent().html(ddata.html);				
			}
		});
