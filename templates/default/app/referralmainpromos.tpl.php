...
<script>
	...
	//myTab.layout.cells('b').conf.tb_height = 31;

	//srt.dummy.apply(myTab.layout.cells('b'));
...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Title, Description, SMS, Start, End, Created, Updated");

			myGrid.setInitWidths("50,70,*,*,*,120,120,120,120");
