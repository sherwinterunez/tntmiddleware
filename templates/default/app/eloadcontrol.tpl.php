...
////////
		...
		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>smart").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>smart").height(lbHeight-61);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>smart").width(lbWidth-2);

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>smartdetailsform_%formval%").height(lbHeight-51);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>smartdetailsform_%formval%").width(lbWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>sun").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>sun").height(lbHeight-61);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>sun").width(lbWidth-2);

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>sundetailsform_%formval%").height(lbHeight-51);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>sundetailsform_%formval%").width(lbWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>globe").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>globe").height(lbHeight-61);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>globe").width(lbWidth-2);

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>globedetailsform_%formval%").height(lbHeight-51);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>globedetailsform_%formval%").width(lbWidth-22);
		}
...
////////
		...
		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>transactiongrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>transactiongrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>transactiongrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>transaction").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>transaction").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>transaction").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>transactiondetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>transactiondetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>productgrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>productgrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>productgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>product").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>product").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>product").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>productdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>productdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>inboxgrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>inboxgrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>inboxgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>inbox").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>inbox").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>inbox").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>inboxdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>inboxdetailsform_%formval%").width(lcWidth-22);
		}

////////

		if($("#formdiv_%formval% #<?php echo $templatemainid; ?>outboxgrid").length) {

			$("#formdiv_%formval% #<?php echo $templatemainid; ?>outboxgrid").height(lbHeight-90);
			$("#formdiv_%formval% #<?php echo $templatemainid; ?>outboxgrid").width(lbWidth);
		...
		if($("#formdiv_%formval% #<?php echo $templatedetailid; ?>outbox").length) {

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>outbox").height(lcHeight-2);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>outbox").width(lcWidth-2);

			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>outboxdetailsform_%formval%").height(lcHeight-51);
			$("#formdiv_%formval% #<?php echo $templatedetailid; ?>outboxdetailsform_%formval%").width(lcWidth-22);
		}
...
////////
	...
	function explorer_sidebar_%formval%(){
		...
		mySideBar = mySideBar_%formval% = myTab.layout.cells('a').attachSidebar({
			...
			items: [
					{id: "smart", text: "Smart Load", icon: "desktop.png"},
					{id: "sun", text: "Sun Load", icon: "desktop.png"},
					{id: "globe", text: "Globe Load", icon: "desktop.png"},
					{id: "transaction", text: "Transactions", icon: "downloads.png"},
					{id: "product", text: "Products", icon: "recent.png"},
					{id: "inbox", text: "Inbox", icon: "music.png"},
					{id: "outbox", text: "Outbox", icon: "desktop.png"},
