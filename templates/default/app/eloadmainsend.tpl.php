...
<script>
	...
	myTab.layout.cells('b').showArrow();
...
///////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGrid.setHeader("#master_checkbox,ID, Product Code, Description, Provider, Cost");

			myGrid.setInitWidths("50,70,200,*,200,200");

			myGrid.setColAlign("center,center,left,left,left,left");

			myGrid.setColTypes("ch,ro,ro,ro,ro,ro");

			myGrid.setColSorting("int,int,str,str,str,int");
