...
<script>
	...
	function <?php echo $wid.$templatedetailid.$submod; ?>_resize_%formval%(myWinObj) {
		...
		$("#<?php echo $wid.$templatedetailid.$submod; ?>detailsform_%formval% .middleware_grid_%formval% .dhxform_container").height(dim[1]-108);
...
///////////////////////////////////
		...
		myTab.postData('/'+settings.router_id+'/json/', {
			...
			myGridMiddleware.setHeader("#master_checkbox, SEQ, ID, DATE/TIME, TYPE, STATUS, SRCHOST, SRCFILE, SRCPATH, TRGTHOST, TRGTFILE, TRGTPATH, &nbsp;, &nbsp;");

			myGridMiddleware.setInitWidths("35,50,50,120,120,120,120,120,120,120,120,120,120,120");

			myGridMiddleware.setColAlign("center,center,center,left,left,left,left,left,left,left,left,left,left,left");

			myGridMiddleware.setColTypes("ch,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");

			myGridMiddleware.setColSorting("int,int,int,str,str,str,str,str,str,str,str,str,str,str");

			myGridMiddleware.attachHeader("&nbsp;,&nbsp;,&nbsp;,#text_filter,#combo_filter,#combo_filter,#combo_filter,#text_filter,#text_filter,#combo_filter,#text_filter,#text_filter,#text_filter,#text_filter");

			myGridMiddleware.init();

			myGridMiddleware.attachEvent("onRowDblClicked", function(rowId,cellIndex){
