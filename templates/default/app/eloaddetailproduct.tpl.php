...
///////////////////////////////////
		...
		$("#<?php echo $templatedetailid.$submod; ?>detailsform_%formval% input[name='eloadproduct_cost']").numeric();
...
///////////////////////////////////
		...
		myForm.attachEvent("onValidateError", function(id,value){
			...
			if(id=='eloadproduct_code') {
				msg = 'Please enter Product Code. This field is required.';
			} else
			if(id=='eloadproduct_desc') {
				msg = 'Please enter Description. This field is required.';
			} else
			if(id=='eloadproduct_provider') {
				msg = 'Please select Provider. This field is required.';
			} else
			if(id=='eloadproduct_cost') {
				msg = 'Please enter Cost. This field is required.';
			}
